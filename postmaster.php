<?php
$EMAIL = 'vlad.corn1@gmail.com'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'vlad.corn1@gmail.com'';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'vlad.corn1@gmail.com'';   //  e-mail для ответа
